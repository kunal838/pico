...
export default function Home() {
  ...
  return (
    <main classNameName="">
      ...
      {/* tabbar */}
      <div class=" backdrop-blur-3xl mx-40 sm:px-4 py-2.5 bg-transparent md:ml-32  max-h-3xl item-center justify-center border-b border-gray-100 m-3 dark:border-gray-100">
...
<CodeEditor uploadData={uploadData} />
